      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {certificationCategories.map((category) => (
          <Link
            key={category.title}
            href={category.href}
            className="group relative h-[420px] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all"
          >
            <img
              src={category.image}
              alt={category.title}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-7 text-white">
              <h3 className="text-xl font-extrabold mb-3 break-keep">
                {category.title}
              </h3>
              <p className="text-white/90 leading-relaxed break-keep text-base whitespace-pre-line">
                {category.description}
              </p>
              <span className="mt-6 inline-flex items-center text-xl font-semibold">
                Read More
                <svg
