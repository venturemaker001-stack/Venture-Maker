...
<section>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-16 items-start">
    ...
    <p className="text-gray-700 text-lg leading-relaxed">
      ...
      기업창작전담부서를 설립하기 위한 설립 주체는
      <br />
      기본적으로 개인기업과 법인기업으로 영리활동을 수행하는
      기관이어야 합니다.
      <br />
      연구개발 및 창작개발 이외의 활동 등에 필요한
      최소한의 인력과 조직, 시설 등을 보유하고 있어야 하며,
      <br />
      연구개발 및 창작개발 활동만을 수행하는 기업은
      인정 받을 수 없습니다.
    </p>
  </div>
</section>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-16 items-stretch">
    ...
    <div className="space-y-8 text-gray-700 text-lg leading-relaxed">
      <p>
        ...
        인정 받을 수 없는 활동을 제외한 활동은
        <br />
        연구개발활동으로 인정됩니다.
        기업부설창작연구소와 창작전담부서는 기술개발 활동만을
        <br />
        수행해서는 안 되며 창작적 요소가 반드시 포함되어야 합니다.
      </p>
